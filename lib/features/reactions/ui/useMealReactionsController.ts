...
export const useMealReactionsController = ({
  meal,
  userUid,
  setComments,
  showToast,
  ...
  const [pendingCommentReactionId, setPendingCommentReactionId] =
...
export { useMealReactionsController as useMealReactions };
