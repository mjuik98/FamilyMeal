...
export default function LoginView() {
    ...
    if (!user) {
        return (
            <div className="flex flex-col min-h-[100dvh] bg-white px-7 pt-[10vh] pb-12 font-sans dark:bg-[#121212]">
                {/* Top Logo Section */}
                <div className="flex justify-center flex-col items-center gap-4 mb-14 mt-4 text-center">
                    <div className="flex items-center justify-center w-[72px] h-[72px] bg-green-50 rounded-[20px] shadow-[0_4px_12px_rgba(0,0,0,0.05)] border border-green-100 dark:bg-green-900/20 dark:border-green-800/50">
                        {/* Use SVG instead of text emoji which can scale poorly and look broken depending on the OS font rendering */}
                    ...
                    <div className="flex flex-col justify-center">
                        <h1 className="text-[34px] font-extrabold text-[#10b981] dark:text-[#34d399] tracking-tight">가족식사</h1>
                        <p className="text-[14px] text-gray-500 font-medium mt-1.5 dark:text-gray-400">함께 쓰는 맛있는 기록</p>
                    </div>
                </div>
                ...
                <div className="mb-12">
                    ...
                    <p className="text-gray-600 text-[16px] leading-relaxed dark:text-gray-400">
                        더 나은 가족 식사 기록을 위해<br />구글 계정으로 로그인해 주세요.
                    </p>
                </div>
                ...
                <div className="mt-auto w-full flex flex-col items-center pb-6">
                    <button
                        ...
                        className="w-full flex justify-center items-center gap-3 bg-[#f3f4f6] text-[#111827] border border-gray-200 rounded-[24px] py-[18px] text-[16px] font-bold shadow-sm hover:bg-[#e5e7eb] active:scale-[0.98] transition-all dark:bg-zinc-800 dark:border-zinc-700 dark:text-white dark:hover:bg-zinc-700"
                    >
